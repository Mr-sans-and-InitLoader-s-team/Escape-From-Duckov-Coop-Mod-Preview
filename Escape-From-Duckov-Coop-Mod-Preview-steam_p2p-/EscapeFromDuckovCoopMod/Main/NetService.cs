...
public class NetService : MonoBehaviour, INetEventListener
{
    ...
    {  
        ...
        if (p2pAvailable)
        {
            ...
            if (IsServer && SteamLobbyManager.Instance != null && !SteamLobbyManager.Instance.IsInLobby)
            {
    ...
    public void StopNetwork()
    {
        ...
        if (TransportMode == NetworkTransportMode.SteamP2P && SteamLobbyManager.Instance != null && SteamLobbyManager.Instance.IsInLobby)
        {
            SteamLobbyManager.Instance.LeaveLobby();
        }
